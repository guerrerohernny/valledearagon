...
const MD = {
  berdun:{
    ...
    media:[
      ...
      {type:'yt', src:'BERDUN_VIDEO1_ID', caption:'Recorrido'},
      {type:'yt', src:'BERDUN_VIDEO2_ID', caption:'Detalles'},
    ]
  },
  mirambel:{
    ...
    media:[
      ...
      {type:'yt', src:'MIRAMBEL_VIDEO1_ID', caption:'Recorrido'},
      {type:'yt', src:'MIRAMBEL_VIDEO2_ID', caption:'Detalles'},
    ]
  },
  arago:{
    ...
    media:[
      ...
      {type:'yt', src:'ARAGO_VIDEO1_ID', caption:'Recorrido'},
      {type:'yt', src:'ARAGO_VIDEO2_ID', caption:'Detalles'},
    ]
  },
  ambel:{
    ...
    media:[
      ...
      {type:'yt', src:'AMBEL_VIDEO1_ID', caption:'Recorrido'},
      {type:'yt', src:'AMBEL_VIDEO2_ID', caption:'Detalles'},
    ]
  },
  morello:{
    name:'Morello', price:'Desde $3,500,000', m2c:'142.62', m2t:'126', beds:'3', baths:'2.5',
    ew:'Nuevo modelo accesible · Solo Manzana 10',
    desc:'El Morello nace para quienes quieren vivir en Valle de Aragón con los mismos acabados premium en un formato compacto y accesible. Se construye exclusivamente en la Manzana 10.',
